...
from common.metods import get_message, send_message, validate_ip, get_pos_ind
...
class TestsMetods(unittest.TestCase):
    ...
    def test_get_pos_ind_1(self):
        """Тест get_pos_ind c параметром [2, -1, -7, 5]"""
        self.assertEqual(get_pos_ind([2, -1, -7, 5]), [0, 3])

    def test_get_pos_ind_2(self):
        """Тест get_pos_ind c параметром [-2, -1, -7, -5]"""
        self.assertEqual(get_pos_ind([-2, -1, -7, -5]), [])
